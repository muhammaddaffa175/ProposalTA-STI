...
\begin{center}
    ...
    {\Large\bfseries Pengembangan Modul E-Complaint Terintegrasi pada Website Layanan Pelanggan SpeedForce di PT Sanders Bersaudara Media}\\
     \vspace{4cm}
    ...
    {\large Oleh}\\[0.3cm]
    \textbf{
    {\large Muhammad Daffa Kusuma Atmaja}\\
    {\large 18222108}
    }\\
